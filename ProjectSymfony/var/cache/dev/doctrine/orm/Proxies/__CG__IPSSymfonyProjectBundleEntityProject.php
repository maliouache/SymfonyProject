 ...
 */
class Project extends \IPS\SymfonyProjectBundle\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'IPS\\SymfonyProjectBundle\\Entity\\Project' . "\0" . 'id', '' . "\0" . 'IPS\\SymfonyProjectBundle\\Entity\\Project' . "\0" . 'nAME', '' . "\0" . 'IPS\\SymfonyProjectBundle\\Entity\\Project' . "\0" . 'iMPORTANCE', '' . "\0" . 'IPS\\SymfonyProjectBundle\\Entity\\Project' . "\0" . 'dEADLINE', '' . "\0" . 'IPS\\SymfonyProjectBundle\\Entity\\Project' . "\0" . 'dOMAIN', '' . "\0" . 'IPS\\SymfonyProjectBundle\\Entity\\Project' . "\0" . 'cOMMENT'];
        }
     ...
     * {@inheritDoc}
     */
    public function init($name, $importance, $deadline, $domain, $comment)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'init', [$name, $importance, $deadline, $domain, $comment]);

        return parent::init($name, $importance, $deadline, $domain, $comment);
    }
